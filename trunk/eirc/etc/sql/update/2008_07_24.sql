...
select @organization_cn:=o.id
from eirc_organizations_tbl o
	inner join eirc_organization_names_tbl n on o.id=n.organization_id
where n.name='ЦН';
select @organization_eirc:=o.id
from eirc_organizations_tbl o
	inner join eirc_organization_names_tbl n on o.id=n.organization_id
where n.name='EIRC';
...
-- Init subdivisions
INSERT INTO eirc_subdivisions_tbl (status, real_address, parent_subdivision_id, head_organization_id, juridical_person_id)
	VALUES (0, '3-я серверная стойка', null, @organization_eirc, @organization_eirc);
...
INSERT INTO eirc_subdivisions_tbl (status, real_address, parent_subdivision_id, head_organization_id, juridical_person_id)
	VALUES (0, '1-я серверная стойка', @subdivision_eirc_it, @organization_eirc, null);
...
INSERT INTO eirc_subdivisions_tbl (status, real_address, parent_subdivision_id, head_organization_id, juridical_person_id)
	VALUES (0, '2-я серверная стойка', @subdivision_eirc_it, @organization_eirc, null);
...
INSERT INTO eirc_subdivisions_tbl (status, real_address, parent_subdivision_id, head_organization_id, juridical_person_id)
	VALUES (0, 'Кабинет направо', null, @organization_eirc, @organization_eirc);
...
INSERT INTO eirc_subdivisions_tbl (status, real_address, parent_subdivision_id, head_organization_id, juridical_person_id)
	VALUES (0, 'Центр клининг-услуг', null, @organization_eirc, @organization_cn);
