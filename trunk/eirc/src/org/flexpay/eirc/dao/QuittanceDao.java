...
public interface QuittanceDao extends GenericDao<Quittance, Long>{
	...
	List<Quittance> listQuittancesForPrinting(Long serviceOrganizationId, Date dateFrom, Date dateTill);
    ...
    /**
     * Returns list of all quitances
     * @return list of all quitances
     */
