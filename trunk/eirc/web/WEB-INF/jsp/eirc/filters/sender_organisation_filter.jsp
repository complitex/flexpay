...
<select name="senderOrganisationFilter.selectedId" class="form-select">
	...
	<option value="<s:property value="id"/>"<s:if test="%{id == senderOrganisationFilter.selectedId}"> selected</s:if>><s:property value="getTranslation(names).name"/></option></s:iterator>
</select>
