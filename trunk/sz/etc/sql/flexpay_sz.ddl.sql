    ...
    alter table SubsReqvNach 
        drop 
        foreign key FK96669C839D0EDA76;
    ...
    alter table characteristic_records_tbl 
        drop 
        foreign key FK98746B9D9D0EDA76;
    ...
    alter table sz_apartment_number_corrections_tbl 
        drop 
        foreign key FK53DEB6E3DEF75687;

    alter table sz_apartment_number_corrections_tbl 
        drop 
        foreign key FK53DEB6E353508F07;

    alter table sz_building_number_corrections_tbl 
        drop 
        foreign key FKCFE53071F71F858D;

    alter table sz_building_number_corrections_tbl 
        drop 
        foreign key FKCFE5307153508F07;

    alter table sz_district_corrections_tbl 
        drop 
        foreign key FK7E38AD7B1AE9F4D;

    alter table sz_district_corrections_tbl 
        drop 
        foreign key FK7E38AD7B53508F07;

    alter table sz_files_tbl 
        drop 
        foreign key FKC3A70A1E96D0F83F;

    alter table sz_files_tbl 
        drop 
        foreign key FKC3A70A1E8A1D7FFF;

    alter table sz_files_tbl 
        drop 
        foreign key FKC3A70A1EFB383BC0;
    ...
    alter table sz_service_type_records_tbl 
        drop 
        foreign key FKAA22F5DE9D0EDA76;

    alter table sz_street_corrections_tbl 
        drop 
        foreign key FK45AF15F0311847ED;

    alter table sz_street_corrections_tbl 
        drop 
        foreign key FK45AF15F053508F07;
    ...
    drop table if exists SubsReqvNach;
    ...
    drop table if exists characteristic_records_tbl;
    ...
    drop table if exists sz_apartment_number_corrections_tbl;

    drop table if exists sz_building_number_corrections_tbl;

    drop table if exists sz_district_corrections_tbl;
    ...
    drop table if exists sz_street_corrections_tbl;
