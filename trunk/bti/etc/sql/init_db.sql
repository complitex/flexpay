...
INSERT INTO bti_apartment_attribute_types_tbl (id, discriminator, group_id, unique_code, is_temporal, status) VALUES
        (1, 'simple',@app_attribute_group_1,'ATTR_NUMBER_OF_HABITANTS', 0, 0),
		(2, 'simple',@app_attribute_group_1,'ATTR_TOTAL_SQUARE', 0, 0),
        (3, 'simple',@app_attribute_group_1,'ATTR_LIVE_SQUARE', 0, 0);
...
INSERT INTO bti_building_attribute_types_tbl (id, discriminator, group_id, unique_code, is_temporal, status) VALUES
        (4,'simple',@attribute_group_1,'ATTR_SECTION_NUMBER', 0, 0),
		(5,'simple',@attribute_group_3,'ATTR_HABITANTS_NUMBER', 0, 0),
		(6,'simple',@attribute_group_2,'ATTR_APARTMENTS_TOTAL_SQUARE', 0, 0),
		(7,'simple',@attribute_group_1,'ATTR_BUILD_YEAR', 0, 0),
		(9,'enum',@attribute_group_2,'ATTR_HOUSE_TYPE', 0, 0),
		(10,'simple',@attribute_group_2,'ATTR_FLOORS_NUMBER', 0, 0),
		(11,'simple',@attribute_group_2,'ATTR_DOORWAYS_NUMBER', 0, 0),
		(12,'simple',@attribute_group_2,'ATTR_APARTMENTS_NUMBER', 0, 0),
		(13,'simple',@attribute_group_2,'ATTR_LIVE_SQUARE', 0, 0),
		(14,'simple',@attribute_group_2,'ATTR_TOTAL_SQUARE', 0, 0),
		(15,'simple',@attribute_group_4,'ATTR_BOILER_PLANT_NUMBER', 0, 0),
		(16,'simple',@attribute_group_4,'ATTR_CENTRAL_WARN_NET_LENGTH', 0, 0),
		(17,'simple',@attribute_group_2,'ATTR_BASEMENTS_NUMBER', 0, 0),
		(18,'simple',@attribute_group_4,'ATTR_TOTAL_SQUARE_WITH_CENTRAL_WARM', 0, 0),
		(19,'simple',@attribute_group_5,'ATTR_TOTAL_SQUARE_WITH_CENTRAL_HOT_WATER', 0, 0),
		(20,'simple',@attribute_group_4,'ATTR_TOTAL_SQUARE_WITH_BOILER_PLANTS', 0, 0),
		(21,'simple',@attribute_group_5,'ATTR_TOTAL_SQUARE_WITH_WATER', 0, 0),
		(22,'simple',@attribute_group_6,'ATTR_TOTAL_SQUARE_WITH_SEWER', 0, 0),
		(23,'simple',@attribute_group_7,'ATTR_TOTAL_SQUARE_WITH_REFUSE_CHUTES', 0, 0),
		(24,'simple',@attribute_group_5,'ATTR_TOTAL_SQUARE_WITH_WATER_PUMPS', 0, 0),
		(25,'simple',@attribute_group_11,'ATTR_ADS_SUITED_APARTMENTS_TOTAL_SQUARE', 0, 0),
		(26,'simple',@attribute_group_6,'ATTR_GUTTER_EQUIPPED_TOTAL_SQUARE', 0, 0),
		(27,'simple',@attribute_group_6,'ATTR_TOILETS_WITH_CENTRAL_SEWER_TOTAL_SQUARE', 0, 0),
		(28,'simple',@attribute_group_2,'ATTR_SOFT_ROOF_SQUARE', 0, 0),
		(29,'simple',@attribute_group_2,'ATTR_HARD_SLATE_ROOF_SQUARE', 0, 0),
		(30,'simple',@attribute_group_2,'ATTR_HARD_METAL_ROOF_SQUARE', 0, 0),
		(31,'simple',@attribute_group_2,'ATTR_BASEMENT_SQUARE', 0, 0),
		(32,'simple',@attribute_group_2,'ATTR_TECHNICAL_FLOORS_SQUARE', 0, 0),
		(33,'simple',@attribute_group_2,'ATTR_ARRET_SQUARE', 0, 0),
		(34,'simple',@attribute_group_9,'ATTR_VENT_CHANNEL_NUMBER', 0, 0),
		(35,'simple',@attribute_group_9,'ATTR_FLUES_NUMBER', 0, 0),
		(36,'simple',@attribute_group_2,'ATTR_FIRST_FLOORS_TOTAL_SQUARE', 0, 0),
		(37,'simple',@attribute_group_10,'ATTR_LIFTED_APARTMENTS_TOTAL_SQUARE', 0, 0),
		(38,'simple',@attribute_group_13,'ATTR_NEAR_HOUSE_NONCATEGORY_TERRITORY_TOTAL_SQUARE', 0, 0),
		(39,'simple',@attribute_group_13,'ATTR_NEAR_HOUSE_1ST_CATEGORY_TERRITORY_TOTAL_SQUARE', 0, 0),
		(40,'simple',@attribute_group_13,'ATTR_NEAR_HOUSE_2ND_CATEGORY_TERRITORY_TOTAL_SQUARE', 0, 0),
		(41,'simple',@attribute_group_13,'ATTR_NEAR_HOUSE_3D_CATEGORY_TERRITORY_TOTAL_SQUARE', 0, 0),
		(42,'simple',@attribute_group_13,'ATTR_NEAR_HOUSE_TERRITORY_TOTAL_SQUARE', 0, 0),
		(43,'simple',@attribute_group_6,'ATTR_INHOUSE_SEWER_LENGTH', 0, 0),
		(44,'enum',@attribute_group_6,'ATTR_INHOUSE_SEWER_MATERIAL', 0, 0),
		(45,'enum',@attribute_group_6,'ATTR_INHOUSE_SEWER_SYSTEM_TYPE', 0, 0),
		(46,'simple',@attribute_group_10,'ATTR_LIFTS_TECH_SUPPORT', 0, 0),
		(47,'simple',@attribute_group_11,'ATTR_DISPETCHER_SYSTEMS_TECH_SUPPORT', 0, 0),
		(48,'simple',@attribute_group_15,'ATTR_COMMON_PLACES_LIGHTENING', 0, 0),
        (49,'simple',@attribute_group_2,'ATTR_OPEN_ELECTRIC_WIRING_APARTMENT_NUMBER', 0, 0),
        (50,'simple',@attribute_group_2,'ATTR_OPEN_ELECTRIC_WIRING_APARTMENT_NUMBER_2', 0, 0);
