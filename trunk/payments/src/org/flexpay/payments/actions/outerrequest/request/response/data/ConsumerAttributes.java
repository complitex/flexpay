...
public class ConsumerAttributes {
    ...
    public static final List<String> EIRC_ATTRIBUTES = list(
            ATTR_NUMBER_TENANTS,
            ATTR_NUMBER_REGISTERED_TENANTS,
            ATTR_TOTAL_SQUARE,
            ATTR_LIVE_SQUARE,
            ATTR_HEATING_SQUARE
    );
	...
	public static final Map<String, Serializable> CALCULATION_ATTRIBUTES = new HashMap<String, Serializable>();
