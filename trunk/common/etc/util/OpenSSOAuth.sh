...
CP=$CP:$LIB2/commons-codec-1.4.jar:$LIB2/commons-io-2.0.1.jar:$LIB2/commons-logging-1.1.1.jar:$LIB2/commons-lang-2.5.jar:$LIB2/commons-collections-3.2.1.jar
