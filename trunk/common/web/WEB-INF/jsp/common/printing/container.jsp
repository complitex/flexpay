...
<body>
    ...
    <div align="center">
        ...
        <object data="<s:url value="/download/%{file.id}.pdf?inline" includeParams="none"/>"
...
<frameset rows="25,*" cols="*">
	<frame src="<s:url value="/resources/common/jsp/print.jsp" includeParams="none" />" id="topFrame" name="topFrame"
		   scrolling="no" />
	<frame src="<s:url value="/download/%{file.id}.pdf?inline" includeParams="none"/>" id="mainFrame"
		   name="mainFrame" />
</frameset>
<%
	}
