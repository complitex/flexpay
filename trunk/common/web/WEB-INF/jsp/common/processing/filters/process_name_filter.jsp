...
<select id="processNameFilter" name="processNameFilter.selectedId" <s:if test="processNameFilter.readOnly">disabled</s:if> <s:if test="processNameFilter.needAutoChange">onchange="pagerAjax(null);"</s:if> class="form-select">
