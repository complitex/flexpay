...
public class RegistryUtil {
	...
	public static final String REGISTRY_RECORD_MESSAGE_TYPE = "" + 0x03;

	public static final String REGISTY_HEADER_MESSAGE_TYPE = "" + 0x0C;
	public static final String REGISTY_FOOTER_MESSAGE_TYPE = "" + 0x0B;
