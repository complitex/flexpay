...
<s:form method="post" id="fSewerTypes">
	...
	<table cellpadding="3" cellspacing="1" border="0" width="100%">
		<tr>
            ...
            <td class="th">
                <s:text name="tc.sewer_type.name" />
            </td>
            <td class="th">
                <s:text name="tc.sewer_type.description" />
            </td>
			<td class="th">&nbsp;</td>
		</tr>
		<s:iterator value="sewerTypes" status="status">
			<tr valign="middle" class="cols_1">
				...
				<td class="col">
                    <a href="<s:url action="sewerTypeEdit"><s:param name="sewerType.id" value="%{id}" /></s:url>"><s:text name="common.edit"/></a>
                </td>
			</tr>
		</s:iterator>
		<tr>
