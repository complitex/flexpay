...
<table cellpadding="3" cellspacing="1" border="0" width="100%">
	<tr>
		...
		<td class="th"><s:text name="ab.town_name"/></td>
		<td class="th">&nbsp;</td>
	</tr>
			...
			<tr valign="middle" class="cols_1">
				...
				<td class="col">
					<s:if test="#{#rowstatus.index > index}">
						...
						<a href="<s:url action='edit_town'><s:param name="temporalId" value="%{temporalId}"/></s:url>">
							<s:text name="ab.edit"/>
						</a>
					</s:if>
				</td>
	...
	<tr>
		<td colspan="6">
			<input type="button" class="btn-exit"
				   onclick="window.location='<s:url action='edit_town'><s:param name="temporalId" value="0"/></s:url>';"
