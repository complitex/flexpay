...
<select name="regionFilter.selectedId" <s:if test="regionFilter.readOnly">disabled="1"</s:if> onchange="this.form.submit()" class="form-select"><s:iterator value="regionFilter.names">
