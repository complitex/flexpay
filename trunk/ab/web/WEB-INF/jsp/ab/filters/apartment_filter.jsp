...
<select name="apartmentFilter.selectedId" <s:if test="apartmentFilter.needAutoChange">onchange="this.form.submit()"</s:if> class="form-select"><s:iterator value="apartmentFilter.apartments">
