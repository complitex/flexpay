...
<select name="townFilter.selectedId" <s:if test="townFilter.disabled">disabled="1"</s:if> onchange="this.form.submit()" class="form-select"><s:iterator value="townFilter.names">
