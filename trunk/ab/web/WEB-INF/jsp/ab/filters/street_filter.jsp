...
<select name="streetFilter.selectedId" <s:if test="streetFilter.readOnly">disabled="1"</s:if> onchange="this.form.submit();" class="form-select"><s:iterator value="streetFilter.names">
