...
<table cellpadding="3" cellspacing="1" border="0" width="100%">
	<form id="srform" method="post" action="<s:url value="/dicts/setRegistrationAction.action" includeParams="none" />">
		...
		<tr class="cols_1">
			<td class="col_1s" colspan="4"><b><s:text name="ab.person.registration"/></b></td>
		</tr>
...
<s:if test="beginIntervalError != null">
	<s:text name="%{beginIntervalError}"/> <s:property value="person.beginValidInterval[0]"/> - <s:property
		value="person.beginValidInterval[1]"/>
</s:if>
