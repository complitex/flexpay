...
<table cellpadding="3" cellspacing="1" border="0" width="100%">
	...
	<s:iterator value="translationList" status="rowstatus">
        <tr valign="middle" class="cols_1">
            ...
            <td class="col"><input type="checkbox" value="<s:property value="%{translatable.id}"/>" name="objectIds"/></td>
			<td class="col">
				<a href="<s:url action="regionsList"><s:param name="countryFilter" value="%{translatable.id}"/></s:url>"><s:property value="name" /></a>
			</td>
			<td class="col">
