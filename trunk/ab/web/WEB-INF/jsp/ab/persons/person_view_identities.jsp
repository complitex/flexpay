...
<table cellpadding="3" cellspacing="1" border="0" width="100%">
	<tr class="cols_1">
		<td class="col_1s" colspan="14"><strong><s:text name="ab.person.documents" /></strong></td>
	</tr>
	<tr class="cols_1">
		<td class="th">&nbsp;</td>
	...
	<s:iterator value="person.personIdentities" status="rowstatus">
		<tr class="cols_1">
			...
			<td class="col" width="1%">
                <input type="checkbox" disabled="disabled"<s:if test="default"> checked</s:if> />
			</td>
			<td class="col"><s:property value="getTranslationName(identityType.translations)" /></td>
