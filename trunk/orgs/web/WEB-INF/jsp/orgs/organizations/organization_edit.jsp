...
<s:form action="organizationEdit">
	...
	<table cellpadding="3" cellspacing="1" border="0" width="100%">
        <tr valign="top" class="cols_1">
            <td class="col"><s:text name="orgs.organization.name" />:</td>
            <td class="col">
		...
		<tr valign="middle" class="cols_1">
			<td class="col"><s:text name="orgs.organization.kpp" />:</td>
			<td class="col"><s:textfield name="organization.kpp" /></td>
		</tr>
		<tr valign="middle" class="cols_1">
			<td class="col"><s:text name="orgs.organization.inn" />:</td>
			<td class="col"><s:textfield name="organization.individualTaxNumber" /></td>
		</tr>
		<tr valign="top" class="cols_1">
			<td class="col"><s:text name="orgs.organization.comment" />:</td>
			<td class="col">
		...
		<tr valign="middle" class="cols_1">
			<td class="col"><s:text name="orgs.organization.juridical_address" />:</td>
			<td class="col"><s:textfield name="organization.juridicalAddress" /></td>
		</tr>
		<tr valign="middle" class="cols_1">
			<td class="col"><s:text name="orgs.organization.postal_address" />:</td>
