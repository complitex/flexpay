...
<s:form action="bankEdit">
	...
	<table cellpadding="3" cellspacing="1" border="0" width="100%">
		...
		<tr valign="top" class="cols_1">
			<td class="col"><s:text name="orgs.bank.description" />:</td>
			<td class="col">
		...
		<tr valign="middle" class="cols_1">
			<td class="col"><s:text name="orgs.bank.bank_identifier_code" />:</td>
			<td class="col"><s:textfield name="bank.bankIdentifierCode" /></td>
		</tr>
		<tr valign="middle" class="cols_1">
			<td class="col"><s:text name="orgs.bank.corresponding_account" />:</td>
