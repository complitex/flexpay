    ...
    create table eirc_consumer_infos_tbl (
        ...
        town_type varchar(255) comment 'Prividers consumer town type name',
        town_name varchar(255) comment 'Prividers consumer town name',
    ...
    create table eirc_quittance_packets_tbl (
        ...
        control_overall_sum decimal(19,2) not null comment 'Control overall sum',
        quittances_number integer not null comment 'Inputed quittances number',
        overall_sum decimal(19,2) not null comment 'Inputed overall sum',
    ...
    create table payments_documents_tbl (
        id bigint not null auto_increment comment 'Primary key',
        version integer not null comment 'Optimistic lock version',
        sum decimal(19,2) not null comment 'Sum',
        debt decimal(19,2) comment 'Debt sum',
        ...
        can_return bit default true not null comment 'Can this document service return or not',
        first_name varchar(255) comment 'Prividers consumer first name',
        middle_name varchar(255) comment 'Prividers consumer middle name',
        last_name varchar(255) comment 'Prividers consumer last name',
    ...
    create table payments_operations_tbl (
        id bigint not null auto_increment comment 'Primary key',
        version integer not null comment 'Optimistic lock version',
        operation_sum decimal(19,2) comment 'Operation sum',
        operation_input_sum decimal(19,2) comment 'Operation input sum',
        change_sum decimal(19,2) comment 'Change',
        can_return bit default true not null comment 'Can this operation return or not',
    ...
    create table payments_services_tbl (
        ...
        can_return bit default true not null comment 'Can this service operations return or not',
    ...
    create table sz_characteristic_records_tbl (
        id bigint not null auto_increment,
    ...
    create table sz_files_tbl (
        ...
        file_date date not null comment 'File date',
        import_date datetime not null comment 'Import date',
        user_name varchar(255) not null comment 'Author of this file',
        oszn_id bigint not null comment 'OSZN reference',
        uploaded_file_id bigint not null unique comment 'Uploaded file reference',
        file_to_download_id bigint unique comment 'File to download reference',
        type_id bigint not null comment 'SZ file type reference',
        status_id bigint not null comment 'SZ file status reference',
        primary key (id)
    );

    create table sz_oszns_tbl (
        id bigint not null auto_increment,
        description varchar(255) not null,
        district_id bigint not null comment 'District reference',
        primary key (id)
    ...
    create table sz_subsidy_records_tbl (
        id bigint not null auto_increment,
        surName varchar(255),
    ...
    alter table sz_characteristic_records_tbl 
        add index FK300ACC759D0EDA76 (sz_file_id), 
        add constraint FK300ACC759D0EDA76 
    ...
    alter table sz_files_tbl 
        add index FKC3A70A1E6755702E (uploaded_file_id), 
        add constraint FKC3A70A1E6755702E 
    ...
    alter table sz_files_tbl 
        add index FKC3A70A1ED8BE29E0 (file_to_download_id), 
        add constraint FKC3A70A1ED8BE29E0 
    ...
    alter table sz_oszns_tbl 
        add index FK_sz_oszns_tbl_district_id (district_id), 
        add constraint FK_sz_oszns_tbl_district_id 
        foreign key (district_id) 
        references ab_districts_tbl (id);
    ...
    alter table sz_subsidy_records_tbl 
        add index FKCFDD2FD59D0EDA76 (sz_file_id), 
        add constraint FKCFDD2FD59D0EDA76 
        foreign key (sz_file_id) 
        references sz_files_tbl (id);
