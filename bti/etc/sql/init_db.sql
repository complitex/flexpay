...
VALUES (4,'simple',@attribute_group_1,NULL),(5,'simple',@attribute_group_1,NULL),(6,'simple',@attribute_group_1,NULL),
(7,'simple',@attribute_group_1,NULL),(9,'enum',@attribute_group_1,NULL),(10,'simple',@attribute_group_1,NULL),(11,'simple',@attribute_group_1,NULL),
(12,'simple',@attribute_group_1,NULL),(13,'simple',@attribute_group_1,NULL),(14,'simple',@attribute_group_1,NULL),(15,'simple',@attribute_group_1,NULL),(16,'simple',@attribute_group_1,NULL),
(17,'simple',@attribute_group_1,NULL),(18,'simple',@attribute_group_1,NULL),(19,'simple',@attribute_group_1,NULL),(20,'simple',@attribute_group_1,NULL),(21,'simple',@attribute_group_1,NULL),
(22,'simple',@attribute_group_1,NULL),(23,'simple',@attribute_group_1,NULL),(24,'simple',@attribute_group_1,NULL),(25,'simple',@attribute_group_1,NULL),(26,'simple',@attribute_group_1,NULL),
(27,'simple',@attribute_group_1,NULL),(28,'simple',@attribute_group_1,NULL),(29,'simple',@attribute_group_1,NULL),(30,'simple',@attribute_group_1,NULL),(31,'simple',@attribute_group_1,NULL),
(32,'simple',@attribute_group_1,NULL),(33,'simple',@attribute_group_1,NULL),(34,'simple',@attribute_group_1,NULL),(35,'simple',@attribute_group_1,NULL),(36,'simple',@attribute_group_1,NULL),
(37,'simple',@attribute_group_1,NULL),(38,'simple',@attribute_group_1,NULL),(39,'simple',@attribute_group_1,NULL),(40,'simple',@attribute_group_1,NULL),(41,'simple',@attribute_group_1,NULL),
(42,'simple',@attribute_group_1,NULL),(43,'simple',@attribute_group_1,NULL),(44,'enum',@attribute_group_1,NULL),(45,'enum',@attribute_group_1,NULL),(46,'simple',@attribute_group_1,NULL),
(47,'simple',@attribute_group_1,NULL),(48,'simple',@attribute_group_1,NULL);
...
(9,'Количество жителей',@ru_id,5),(10,'Overall flat square',@en_id,6),(11,'Общая площадь квартир',@ru_id,6),(12,'Год постройки',@ru_id,7),
(14,'Серия, тип дома',@ru_id,9),(15,'Количество этажей',@ru_id,10),(16,'Количество подъездов',@ru_id,11),(17,'Количество квартир',@ru_id,12),(18,'Жилая площадь',@ru_id,13),
(19,'Общая площадь жилого фонда',@ru_id,14),(20,'Количество бойлерных установок',@ru_id,15),(21,'Протяженность сетей цетрального отопления',@ru_id,16),(22,'Количество подвалов',@ru_id,17),
(23,'Общая площадь жилого фонда, оборудованного центральным отоплением',@ru_id,18),(24,'Общая площадь жилого фонда, оборудованного центральным горячим водоснабжением',@ru_id,19),
(25,'Общая площадь жилого фонда с бойлерными установками',@ru_id,20),(26,'Общая площадь жилого фонда, оборудованного водопроводом ',@ru_id,21),
(27,'Общая площадь жилого фонда, оборудованного канализацией',@ru_id,22),(28,'Общая площадь жилого фонда, оборудованного мусоропроводами',@ru_id,23),
(29,'Общая площадь жилых помещений в домах, где вода подается при помощи насосов подкчки ',@ru_id,24),(30,'Общая площадь квартир в домах, оборудованных АДС',@ru_id,25),
(31,'Общая площадь жилого фонда, оборудованного водостоками',@ru_id,26),
(32,'Общая площадь жилого фонда, жильцы которого пользуются дворовыми туалетами, подключенными к центральной канализации',@ru_id,27),(33,'Площадь мягкой кровли ',@ru_id,28),
(34,'Площадь шифера',@ru_id,29),(35,'Площадь металической кровли',@ru_id,30),(36,'Площадь подвалов',@ru_id,31),(37,'Площадь технических этажей',@ru_id,32),(38,'Площадь чердаков',@ru_id,33),
(39,'Количество вентиляционных каналов',@ru_id,34),(40,'Количество дымоходов',@ru_id,35),(41,'Общая площадь первых этажей ',@ru_id,36),
(42,'Общая площадь квартир, оборудованных лифтами',@ru_id,37),(43,'Площади внекатигорийной придомовой территории',@ru_id,38),(44,'Площади придомовой территории 1-й категории',@ru_id,39),
(45,'Площади придомовой территории 2-й категории',@ru_id,40),(46,'Площади придомовой территории 3-й категории',@ru_id,41),(47,'Общая площади придомовой территории',@ru_id,42),
(48,'Протяженность внутридомойвой канализации',@ru_id,43),(49,'Материал внутридомойвой канализации',@ru_id,44),(50,'Тип системы внутридомойвой канализации',@ru_id,45),
(51,'Технологическое обслуживание лифтов в месяц',@ru_id,46),(52,'Диспетчеризация в месяц',@ru_id,47),(53,'Освещение мест общего пользования ',@ru_id,48);
