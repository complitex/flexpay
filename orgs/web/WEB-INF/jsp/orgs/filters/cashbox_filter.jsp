...
<s:if test="cashboxFilter.readOnly">
    ...
    <select name="cashboxFilter.selectedId"<s:if test="cashboxFilter.needAutoChange"> onchange="this.form.submit();"</s:if> class="form-select">
	<s:if test="cashboxFilter.allowEmpty"><option value="-1"><s:text name="payments.cashbox" /></option></s:if>
