...
import org.flexpay.eirc.process.registry.IterateMBCorrectionsActionHandler;
...
public class TestMbCorrectionsFileParser2 extends TestSpFileCreateAction {
	...
	private List<Registry> parseRegistryFile(FPFile newFile) throws ProcessDefinitionException, ProcessInstanceException, InterruptedException {
		...
		parameters.put(IterateMBCorrectionsActionHandler.PARAM_FILE_ID, newFile.getId());
		...
		Long registryId = (Long)parameters.get(IterateMBCorrectionsActionHandler.PARAM_REGISTRY_ID);
