                ...
                <td align="right">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            ...
                            <td>
                                <input type="button" value="<s:text name="logout.link.title" />" class="btn-exit" onclick="location.href='<s:url value="/logout" includeParams="none" />';" />
                            </td>
                        ...
                        <tr>
                            <td align="right">
                                <span class="text-small">
                                    <s:property value="getPaymentPointInfoString()" />,&nbsp;<s:property value="getCashboxInfoString()" />
                                </span>
                            </td>
                        </tr>
                    </table>
