	...
	<s:if test="%{resultsAreNotEmpty()}">
		<table cellpadding="3" cellspacing="1" border="0" width="100%">
			<s:iterator value="quittanceInfos" id="qi">
				<tr><td colspan="5"><s:property value="%{getPersonFio(#qi)}"/></td></tr>

				<s:if test="%{actionName == 'searchByEircAccount' || actionName == 'searchByQuittanceNumber'}">
					<tr><td colspan="5"><s:property value="%{getApartmentAddress(#qi)}"/></td></tr>
				</s:if>
				...
				<s:iterator value="detailses" status="status">
					...
					<tr class="cols_1">
						...
						<td class="col"><s:textfield name="paymentsMap[%{#serviceId}]" value="%{outgoingBalance}" cssStyle="width: 100%; text-align: right;"/></td>
					</tr>
				</s:iterator>
				...
				<tr class="cols_1">
					...
					<td class="col"><s:textfield name="totalToPay" readonly="true" value="%{totalToPay}" cssStyle="width: 100%; text-align: right;"/></td>
				</tr>
