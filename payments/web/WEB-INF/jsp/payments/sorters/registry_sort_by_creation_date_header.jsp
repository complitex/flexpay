...
<input type="button" class="btn-link" id="registrySorterByCreationDateButton"
       onclick="<s:if test="registrySorterByCreationDate.activated">$('#registrySorterByCreationDateOrder').val('<s:property value="registrySorterByCreationDate.oppositeOrder" />');</s:if>FP.activateSorter('registrySorterByCreationDateActive');" value="<s:text name="payments.date" />" />
