...
public abstract class Roles {
	...
	public static final String ROLE_MENU_PAYMENTS_OPERATIONS_ADDRESS = MENU_PAYMENTS_PREFIX + "_OPERATIONS_ADDRESS";
	public static final String ROLE_MENU_PAYMENTS_OPERATIONS_ACCOUNT = MENU_PAYMENTS_PREFIX + "_OPERATIONS_ACCOUNT";
	public static final String ROLE_MENU_PAYMENTS_OPERATIONS_QUITTANCE = MENU_PAYMENTS_PREFIX + "_OPERATIONS_QUITTANCE";
	public static final String ROLE_MENU_PAYMENTS_REPORTS_ADDRESS = MENU_PAYMENTS_PREFIX + "_REPORTS_ADDRESS";
	public static final String ROLE_MENU_PAYMENTS_REPORTS_ACCOUNT = MENU_PAYMENTS_PREFIX + "_REPORTS_ACCOUNT";
	public static final String ROLE_MENU_PAYMENTS_REPORTS_QUITTANCE = MENU_PAYMENTS_PREFIX + "_REPORTS_QUITTANCE";
	public static final String ROLE_MENU_PAYMENTS_REPORTS_REPORTS = MENU_PAYMENTS_PREFIX + "_REPORTS_REPORTS";

	public static final String ROLE_MENU_PAYMENTS_OPERATIONS_LIST_ADDRESS = MENU_PAYMENTS_PREFIX + "_OPERATIONS_LIST_ADDRESS";
	public static final String ROLE_MENU_PAYMENTS_OPERATIONS_LIST_ACCOUNT = MENU_PAYMENTS_PREFIX + "_OPERATIONS_LIST_ACCOUNT";
	public static final String ROLE_MENU_PAYMENTS_OPERATIONS_LIST_QUITTANCE = MENU_PAYMENTS_PREFIX + "_OPERATIONS_LIST_QUITTANCE";
	public static final String ROLE_MENU_PAYMENTS_TAKEN_REPORTS_ADDRESS = MENU_PAYMENTS_PREFIX + "_TAKEN_REPORTS_ADDRESS";
	public static final String ROLE_MENU_PAYMENTS_TAKEN_REPORTS_ACCOUNT = MENU_PAYMENTS_PREFIX + "_TAKEN_REPORTS_ACCOUNT";
	public static final String ROLE_MENU_PAYMENTS_TAKEN_REPORTS_QUITTANCE = MENU_PAYMENTS_PREFIX + "_TAKEN_REPORTS_QUITTANCE";
