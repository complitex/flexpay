...
public abstract class Roles {
	...
	public static final String ROLE_MENU_PAYMENTS_TAKEN_REPORTS = MENU_PAYMENTS_PREFIX + "_TAKEN_REPORTS";
	public static final String ROLE_MENU_PAYMENTS_IMPORT_PAYMENTS = MENU_PAYMENTS_PREFIX + "_IMPORT_PAYMENTS";
