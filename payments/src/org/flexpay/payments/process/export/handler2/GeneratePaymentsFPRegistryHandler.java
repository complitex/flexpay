...
public class GeneratePaymentsFPRegistryHandler extends TaskHandler {
     ...
     * {@link org.flexpay.payments.process.export.ExportJobParameterNames#REGISTRY} (type value is {@link org.flexpay.common.persistence.registry.Registry})
     *
    ...
    private Registry getRegistry(Map<String, Object> parameters) {
		...
		if (parameters.containsKey(REGISTRY)) {
			...
			registry = registryService.readWithContainers(new Stub<Registry>(registryId));
		}

		return registry;
	}

	private String getPrivateKey(Map<String, Object> parameters) {
