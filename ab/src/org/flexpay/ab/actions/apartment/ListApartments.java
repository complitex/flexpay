...
public class ListApartments extends BuildingsActionsBase implements SessionAware {

	private static final String ATTRIBUTE_ACTION_ERRORS =
			ListApartments.class.getName() + ".ACTION_ERRORS";

	private static Logger log = Logger.getLogger(org.flexpay.ab.actions.buildings.ListBuildings.class);
	...
	public String execute() throws Exception {
		...
		if (log.isInfoEnabled()) {
			log.info("Listing apartments: " + (System.currentTimeMillis() - start) + " ms");
		}
		return SUCCESS;
	}
