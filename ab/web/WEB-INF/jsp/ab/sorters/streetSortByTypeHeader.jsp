...
<input type="submit" class="btn-link" onclick="<s:if test="streetSorterByType.activated">jQuery('#streetSorterByTypeOrder').val('<s:property value="%{streetSorterByType.oppositeOrder}" />');</s:if>FP.activateSorter('streetSorterByTypeActive');" value="<s:text name="ab.street_type"/>"/>
