	...
	<table cellpadding="3" cellspacing="1" border="0" width="100%">
		...
		<s:iterator value="streetTypes" status="rowstatus">
			<tr valign="middle" class="cols_1">
				...
				<td class="col">
					<a href="<s:url action='streetTypeView'><s:param name="id" value="%{id}"/></s:url>">
						<s:property value="%{getTranslationName(translations)}" />
					</a>
				</td>
				<td class="col">
					<a href="<s:url action='editStreetType'><s:param name="streetType.id" value="%{id}"/></s:url>">
						<s:text name="ab.edit" />
					</a>
				</td>
			</tr>
		...
		<tr>
			<td colspan="5">
				<input type="submit" class="btn-exit"
					   onclick="$('#fobjects').attr('action','<s:url action="streetTypeDelete" includeParams="none" />');"
