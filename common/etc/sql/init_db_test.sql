...
-- certificates
insert into common_certificates_tbl (version, user_preference_id, begin_date, end_date, description) values (0, @user_test, '2010-03-22', '2010-06-20', 'Tecтовый логин');
