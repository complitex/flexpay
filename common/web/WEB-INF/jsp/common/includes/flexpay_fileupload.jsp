...
<script type="text/javascript" src="<s:url value="/resources/common/js/flexpay_fileupload.js" includeParams="none" />"></script>
<script type="text/javascript">

    FPFile.constants = {
        progressBarUrl: "<s:url action="fileUploadProgress" namespace="/common" includeParams="none" />",
