...
<select name="processNameFilter.selectedId" <s:if test="processNameFilter.readOnly">disabled="1"</s:if> <s:if test="processNameFilter.needAutoChange">onchange="this.form.submit();"</s:if> class="form-select">
