...
<div align="center">
	...
	<object data="<s:url value="/download/" includeParams="none"/><s:property value="%{file.id}"/>.pdf?inline=1"
...
<frameset rows="25,*" cols="*">
	<frame src="<s:url value="/resources/common/jsp/print.jsp" includeParams="none" />" id="topFrame" name="topFrame"
		   scrolling="no" />
	<frame src="<s:url value="/download/" includeParams="none"/><s:property value="%{file.id}"/>.pdf?inline=1" id="mainFrame"
		   name="mainFrame" />
</frameset>
<%
	}
