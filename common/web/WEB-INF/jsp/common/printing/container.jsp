...
<body onload="window.print();">
    <s:if test="file.extension == '.html' || file.extension == '.txt' || file.extension == '.csv'">
        ...
        <div align="center">
            <input type="button" onclick="printMainFrame();return false;" value="<s:text name="common.print" />" class="btn-exit" />
            <input type="button" onclick="parent.close();" value="<s:text name="common.close_window" />" class="btn-exit" />
        </div>
        ...
        <div align="center">
            <input type="button" onclick="window.close();" value="<s:text name="common.close_window" />" class="btn-exit" />
