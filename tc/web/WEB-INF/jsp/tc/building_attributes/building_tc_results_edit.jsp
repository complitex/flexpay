...
<script type="text/javascript">
    ...
    jQuery(function() {
        var validator = jQuery('#tcResultsEdit').validate({
            rules: {
            ...
            success: function(label) {
                if (validator.numberOfInvalids() == 0) {
                    jQuery('#tcResultsEdit_errors').hide();
                }
            },
            showErrors: function(errorMap, errorList) {
                jQuery('#tcResultsEdit_errors').html("<s:text name="tc.error.tc.results.form.contains.errors"/>").addClass("cols_1_error").show();
...
<s:form id="tcResultsEdit" action="buildingTCResultsEdit">
    <table cellpadding="3" cellspacing="1" border="0" width="100%">
        ...
        <tr>
            <td id="tcResultsEdit_errors" colspan="2" style="display: none;"/>
        </tr>
